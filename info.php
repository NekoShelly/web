...
<head>
    ...
    <title>Informazioni PHP - MICHELLE D_ANDREA</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per MICHELLE D_ANDREA</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> MICHELLE D_ANDREA</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> dandrea.michelle</p>
